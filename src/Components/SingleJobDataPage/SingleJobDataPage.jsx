...
import { addDb } from '../LocalStroge/LocalStrogeDb';




const SingleJobDataPage = () => {
    const jobId = useParams()
    // console.log(job.jobId);
    const [featureJobs, setJobs] = useState([])
    useEffect(() => {
        fetch('/public/mainJobsItem.json')
            .then(res => res.json())
        ...
        <div className='my-simple-container'>
            ...
            <div className='md:flex gap-8 items-center'>
                ...
                <div className='lg:w-2/5 w-full mt-16'>
                    ...
                    <button onClick={()=>{addDb(id)}} className='my-btn w-full'>Apply Now</button>
                </div>
            </div>
        </div>
    );
...
export default SingleJobDataPage;